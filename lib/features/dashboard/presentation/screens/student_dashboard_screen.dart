          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: SectionHeader(
                title: 'My Batches',
                actionLabel: 'See All',
                onAction: () => context.push(AppRoutes.studentBatches),
              ),
            ),
          ),
          SliverToBoxAdapter(
            child: userAsync.when(
              data: (user) => user == null
                  ...
                  : _StudentBatchStrip(userId: user.id),
              loading: () => const SizedBox(
                  height: 60,
...
// ── Student Batch Strip ────────────────────────────────────────
class _StudentBatchStrip extends ConsumerWidget {
  final String userId;
  const _StudentBatchStrip({required this.userId});
            ...
            itemBuilder: (_, i) {
              ...
              return Padding(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(12),
                  onTap: () =>
                      context.push(AppRoutes.studentBatchesPath()),
                  child: Container(
                    width: 180,
